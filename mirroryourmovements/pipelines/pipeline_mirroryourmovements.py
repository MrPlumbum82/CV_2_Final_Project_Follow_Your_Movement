...
@dataclass
class MirrorYourMovementsPipelineOutput(BaseOutput):
    videos: Union[torch.Tensor, np.ndarray]


class MirrorYourMovementsPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        return MirrorYourMovementsPipelineOutput(videos=video)
